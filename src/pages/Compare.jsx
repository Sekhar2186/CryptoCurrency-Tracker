    ...
    <div className="min-h-screen bg-[#08090a] text-white">
      ...
      {loading || !coin1Data?.id || !coin2Data?.id ? (
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="mb-8 rounded-2xl overflow-hidden border border-[#1e2028] bg-[#101114]">
            <SelectCoins
              allCoins={allCoins}
              crypto1={crypto1}
              crypto2={crypto2}
          ...
          <div className="space-y-6">
            {/* Coin 1 Card */}
            <div className="bg-[#101114] border border-[#1e2028] rounded-2xl p-4 shadow-lg overflow-x-auto">
            ...
            {/* Price Chart */}
            <div className="bg-[#101114] border border-[#1e2028] rounded-2xl p-6 shadow-lg">
              <ToggleComponents
                priceType={priceType}
